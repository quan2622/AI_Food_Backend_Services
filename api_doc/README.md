...
| [admin-reference-allcodes-api.md](./admin-reference-allcodes-api.md) | Allcodes — mã tham chiếu (dropdown, meal type, …) |
...
| Thực phẩm & danh mục | `GET /foods/admin`, `food-categories` |
| Nguyên liệu / allergen | `GET /allergens/admin`, `GET /ingredient-allergens/admin`, `foods/:id/ingredients` |
...
| `/foods/admin` | `foodCategory` (không phải keyMap trên Food) |
| `/allergens/admin` | — |
